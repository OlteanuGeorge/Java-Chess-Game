...
public class Board extends JPanel {
    ...
    public void makeMove(Move move) {
        if (move.piece.isWhite == isWhiteTurn) {
            if (isValidMove(move)) {
                ...
                repaint(); // Make sure to repaint the board after a move
            }
        }
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if(selectedPiece != null) {
            for (int r = 0; r <= rows; r++) {
                for (int c = 0; c <= cols; c++) {
                    Move potentialMove = new Move(this, selectedPiece, c, r);
                    if (isValidMove(potentialMove)) {
                        g2d.setColor(new Color(68, 180, 59, 190));
                        g2d.fillRect(c * tileSize, r * tileSize, tileSize, tileSize);
                    ...
                    if(isKingInCheck) g2d.setColor(new Color(220, 43, 43, 190));
                }
            }
        }
